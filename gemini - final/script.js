...
const WORKER_URL = "https://proud-waterfall-d232.dishantwork7.workers.dev/";
...
// ====== Gemini Response using Cloudflare Worker ======
...
// ====== Pollinations Image Generator (unchanged) ======
...
const handleFormSubmit = (e) => {
  ...
  if (isImageRequest) {
    ...
    generateImage(promptText).then((url) => {
